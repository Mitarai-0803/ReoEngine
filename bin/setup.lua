	...
	--============================================================================
	-- Visual Studio フィルタ自動生成
	--============================================================================
	function setup_class_filters(root_path)
    ...
    ------------------------------------------------------------
    local all_files =
        os.matchfiles(path.join(root_path, "**.*"))
    ...
    for _, filepath in ipairs(all_files) do
		...
		-- クラス系分類（含まれてたら入れる）
		------------------------------------------------------------
		if basename:find("Object") then
    	filter_name = "Object/" .. basename

		elseif basename:find("Scene") then
    	filter_name = "Scene/" .. basename

		elseif basename:find("Component") then
    	filter_name = "Component/" .. basename

		elseif basename:find("Constant") then
    	filter_name = "Constant/" .. basename
        ...
        --------------------------------------------------------
            ...
            filter_name = "System/" .. basename
        end

        vpath_table[filter_name] =
            vpath_table[filter_name] or {}
