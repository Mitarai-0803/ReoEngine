...
-- ソリューションファイル
--============================================================================
config_solution("GameSample")
    startproject "GameSample"		-- スタートアッププロジェクト名
...
config_project("hlsl++", "StaticLib")
	...
	local SOURCE_PATH = "opensource/hlslpp/include"
...
--============================================================================
group ""
config_project("GameSample", "WindowedApp")
...
--	}
	...
	-- フィルタ自動生成
	setup_class_filters(SOURCE_PATH, DATA_PATH)
